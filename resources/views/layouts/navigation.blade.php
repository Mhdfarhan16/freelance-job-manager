    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-20'"
        ...
        <div class="flex items-center justify-between mb-8">
            <div :class="sidebarOpen ? 'opacity-100' : 'opacity-0'"
                class="text-2xl font-bold transition-opacity duration-200 whitespace-nowrap">
                JobManager
            </div>
            <button @click="sidebarOpen = !sidebarOpen"
                class="p-2 rounded-lg hover:bg-white/20 transition-all duration-200 hover:scale-110">
                <svg class="w-6 h-6 transition-transform duration-300" :class="sidebarOpen ? '' : 'rotate-180'"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div
                        ...
                        <div class="hidden sm:block">
                            <div class="text-sm font-semibold text-gray-700">{{ Auth::user()->name ?? 'User' }}</div>
