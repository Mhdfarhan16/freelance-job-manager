                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center group cursor-pointer">
                            <input type="checkbox" name="remember" id="remember_me"
                                class="w-5 h-5 border-2 border-blue-300 rounded-md text-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 cursor-pointer transition-all">
                            <span
                                class="ml-2 text-sm text-gray-700 group-hover:text-blue-600 transition-colors">Remember
                                me</span>
                        </label>
